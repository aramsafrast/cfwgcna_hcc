...
# Weighted gene co-expression analysis of all plasma cfRNA samples - healhty cohort + hcc cohort
***
...
```{r modules, message=F, warning=F}
dir.create("./cfrna/results/cytoscape/")
...
for (modules in module) {
  ...
  nTop = 30; 
  IMConn = softConnectivity(cfrna_wgcna_input[, modProbes]);
