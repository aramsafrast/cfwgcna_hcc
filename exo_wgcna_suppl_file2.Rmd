...
title: "WGCNA of exoRNA samples & generation of Suppl. File 2"
...
```{r supp_file, warning=F, message=F}
...
for (modules in module) {
  ...
  IMConn <- softConnectivity(exorna_wgcna_input[, modProbes], type = "unsigned", power = 6)
