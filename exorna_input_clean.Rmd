...
* hence by default won't run
* ready-made count matrix already provided
* to run this code chunk set eval=TRUE
* >120G disk space needed locally
***
...
STAR --runThreadN 8 --runMode genomeGenerate --genomeDir ./exorna/data/raw/hs_genome/star/ --genomeFastaFiles ./exorna/data/raw/hs_genome/hg38.fa --sjdbGTFfile ./exorna/data/raw/hs_genome/hg38.gtf
for f in {516..536} ; do fasterq-dump SRR5712"$f" -O ./exorna/data/raw -t ./exorna/data/raw ; gzip *fastq ; done
#map with STAR
for f in {516..536} ; do STAR --runMode alignReads --sjdbGTFfile ./exorna/data/raw/hs_genome/hg38.gtf --readFilesIn ./exorna/data/raw/fastq/SRR5712"$f"_1.fastq.gz ./exorna/data/raw/fastq/SRR5712"$f"_2.fastq.gz --readFilesCommand "gunzip -c" --outSAMtype BAM SortedByCoordinate --genomeDir  ./exorna/data/raw/hs_genome/hg38.fa --outFileNamePrefix ./exorna/data/raw/map/"$f" --runThreadN 8 : done
featureCounts -T 8 -p -s 1 -a ./exorna/data/raw/hs_genome/hg38.gtf -o ./exorna/data/raw/exorna_countm.txt ./exorna/data/raw/map/*bam
#download the metadata
wget -q -nv -O ./exorna/data/raw/exorna_metadata_init.csv "https://trace.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?save=efetch&db=sra&rettype=runinfo&term=SRP109668"
```
